...
st.title(f":cup_with_straw: Customzie Your Smoothie! :cup_with_straw:")
st.write(
  """Choose the fruits you want in your custom Smoothie """ 
)


name_on_smoothie = st.text_input('Name of Smoothie')
...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        st.write(friut_chosen, search_on)
    ...
    ('""" + ingredients_string + """','""" + name_on_smoothie + """')"""
